...
class ChainerRLAtariDemoParser():
    """Parses Atari demonstrations generated by a standard ChainerRL agent.
    """
    def __init__(self, demo_pickle_file, env, num_demos, outdir):
        self.outdir = outdir
